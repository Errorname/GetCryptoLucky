var faq = [
	{
		title: 'What is this?',
		description: 'This is a simple game of chance. You spin the slot machine. And you wait to see if you won.'
	},
	{
		title: 'How does this work?',
		description: 'Every time you spin the machine, it generates a random cryptocurrency wallet with the public and private key. Then it will check if there is coins already at the address of the wallet.'
	},
	{
		title: 'What are my chances?',
		description: 'This is quite a complicated questions. To put it simply, it depends on the algorithms used to generate these cryptocurrency wallets. ' +
	...
	},
	{
		...
		description: '<b>340,282,366,920,938,463,463,374,607,431,768,211,456</b><br>' +
	...
	{
		title: 'Is it legal?',
		description: '<b>Disclaimer:</b> I\'m NOT a lawyer.<br>' +
